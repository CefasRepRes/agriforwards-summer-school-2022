...
- The trip to The Broads is too expensive, so can it.

- [x] Questions about gender balance etc. in the allocations.

- Rob to figure out risk assessment to allow Cefas people to go
      boating on The Broads. Superseded.

- [x] Richard and Julie to talk urgently to the student who has
      objections to killing fish.

- [x] Look at skill set of the students and allocate them to modules accordingly.
